# -*- coding: utf-8 -*-
"""
Created on Tue Nov 22 05:27:50 2022
...
def crossroads():
    ...
    print('''The World's Map on The Crossroads Sign:
                      ...
                      Peaceful Forest      Colossal Gate
                              ||                ||
                            Dark Cave           North       Forest   Camelot   Graveyard
                              ||                ||            \\\     ||      //
TBC===Ocean===Dock===Beach===West==========Crossroads================East==============TBC
                                                ||                    || 
                               Merchant========South                portal      
                                                ||
                            Camelot===Bridge of Souls===Garden of eden
          ''')
    decision = input(
        '''You find yourself at The Crossroad of worlds, which seems the center of the world.
Do you want to move west, south, north, or move east? (type commands like w or west) \n''')
    ...
    if decision == 'east' or decision == 'e':
        ...
        game.equipped_chest = ['camelot chestplate']
...
class Config:
    def __init__(self):
        self.levels = {1: 0, 2: 25, 3: 75, 4: 150, 5: 250, 6: 375,
                       7: 525, 8: 700, 9: 900, 10: 1150, 11: 1450, 12: 1800}
        self.ranks = {1: 1, 2: 5, 3: 10, 4: 20,
                      5: 40, 6: 80, 7: 160, 8: 320, 9: 640}
        self.points = 15
...
class Story:
     def __init__(self):
         self.beach_story = "You decide to walk barefoot along the beach. The waves hit your feet. You can see in the distance a figure standing the the end of the dock."
         self.southern_story = 'You headed south until you came upon a fork in the road. You can go west to the merchant or continue heading south to the bridge of souls. Few have been known to survive the merciless souls that are said to hiding at the bridge of souls. You see a merchant selling survival gear nearby.'
         self.eastern_story = "'North of you you see a field, to the west of you is a crossroad, to the northwest you see a forest\n South of you you see a portal, and to the northeast you see a graveyard\n"        
         self.dock_story = '''As you approach the figure on the dock the figure turns to face you, and you find yourself staring back at you. The figure then intoduces himself as the future youcaptain of a nearby vessal.\n
...
def beach_scene():
     ...
     decision = input(
         'would you like to go back to the entrance of the dark cave or check out the sea?\n')
     if decision == 'sea':
         game.prev_location = beach_scene
         #dock_scene()
         decision2 = input(
             "are you sure this is a dungeon that could easily kill you, would you like to move forward?\n")
...
def portal():
     global game
     game.location = portal
     print("you get on the trail and follow it to the portal ahead of you\n")
     print("When you reach the portal you see that it has five slots; one slot had a gray gem embedded in the slot. A spirit appears and explains to you the story behind the portal. Once this land had bountiful resources and both the humans and demons lived peaceful lives. But this peace was not to last forever.  One day the Demon armies forces charged through the gate. They destroyed and pillaged everything in sight. Eventually The countries five hero's as well as thier armies stood against the demons in a long war. In the end only one hero remained. He defeated the demon king and returned the demons back to their home world. With the remainder of his strength he destroyed the demon's only way to return to our world, the portal. With the portal out of the way the hero hid the sacred gems throughout the world with the goal of the emons never being allowed to return again. But as of recently the demons have grown more powerful, and have found a way to create a new portal. All of the gems besides the gray one were eventually lost to time. It is now your job to find the remaining gems, repair the portal and defeat the demons that lay within.\n")
     ...
     if decision == 'y' or decision == 'yes':
         if game.quest[0] != "hero's quest" or game.quest[1] != "hero's quest" or game.quest[2] != "hero's quest":
             ...
             print(
                 "you have taken the quest. The spirit tells you the first gem resides where the serpant lies\n")
             game.prev_location = portal
             eastern_scene()
         else:
...
def southern_scene():
     ...
     decision = input('choose either to go to the merchant, or to the bridge.\n')
     if decision == 'north' or decision == 'n':
         print('You walk back to the crossroad')
         game.prev_location = southern_scene
         crossroads()
     if decision == 'merchant':
         enter_Camelot_market()
     elif decision == 'south' or decision == 's':
         if 'Camelot chestplate' in game.equipped_chest:
             print(
                 "Knowing you have the necessary gear to enter the Camelot, you walk to the Bridge of Souls.\n ")
             game.prev_location = southern_scene
             bridge_of_souls_scene()
         elif 'Camelot chestplate' not in game.equipped_chest:
             print(
                 'You do not have the required gear to go across the Bridge of Souls, try going to the merchant')
             southern_scene()
         elif decision == 'help':
             print('please, type south, or north\n')


def bridge_of_souls_scene():
     global game
     game.location = bridge_of_souls_scene
     print('you can move either west to the Camelot, north back to the southern pass, or east to the Garden of Eden')
     decision = input('choose either west, north, east\n')
     if decision == 'west' or decision == 'w':
         game.prev_location = bridge_of_souls_scene
         Camelot_trial()
         ...
         if "hero's quest" in game.quest and "Yellow gem" not in game.key_items:
             ...
             print(
                 "you don't have a reason to enter the Garden of Eden (maybe you are missing a quest?)\n")
             bridge_of_souls_scene()
...
def Camelot_trial():
     global game, gconfig
     game.location = Camelot_trial
     if game.dungeon_kills < 8:
         game.dungeon_kills += 1
         attack_regular(Camelot_trial, 'Camelot trial 1', True)
     elif 8 <= game.dungeon_kills < 11:
         if game.dungeon_kills == 8:
             print('The Second stage of the Trial is starting!')
             hp_station = math.ceil(game.max_health*0.8)
             ...
             while game.dungeon_kills < 11:
                 game.dungeon_kills += 1
                 attack_regular(Camelot_trial, 'Camelot trial 2', True)
     elif 11 <= game.dungeon_kills and game.dungeon_kills < 12:
         if game.dungeon_kills == 11:
             print('The Third stage of the Trial is starting!')
             hp_station = math.ceil(game.max_health*0.8)
             if game.health < hp_station:
                 ...
                 print(f'The fountain of Health has restored {restored} HP!')
         game.dungeon_kills += 1
         attack_regular(Camelot_trial, 'Camelot trial 3', True)
     elif game.dungeon_kills == 12:
         print("you cleared the dungeon!")
         print("you got 10,000 gold as a reward")
         game.gold += 10000
         ...
         game.dungeon_kills = 0
         print(game)
         game.prev_location = Camelot_trial
         bridge_of_souls_scene()


def Camelot_scene():
    global game
    game.location = Camelot_scene
    print('you entered the Camelot')
    Camelot = input('''as you enter the village a few establishments stands out to you.
    ...
    if Camelot == 'inn' or Camelot == 'i' and game.gold >= 100:
        villageinn()
    elif Camelot == 'inn' and game.gold < 100:
        print("You can not afford to heal you are {} gold short".format(
            100 - game.gold))
    elif Camelot == 'shop':
        enter_village_shop()
    elif Camelot == 'guild':
        ...
        game.prev_location =Camelot_trial
        enter_hero_screen()
    if Camelot == 'no' or Camelot == 'n' or Camelot == 'exit' or Camelot == 'leave' or Camelot == 'road':
        print("You decide to leave the Camelot and return to the Bridge of Souls")
        bridge_of_souls_scene()

# # code for the Camelot market

def enter_Camelot_market():
     global game, gconfig
     if game.player_level < 50:
         shop_choice = input('''you see healing drinks, 50g each,
                            and a Camelot chestplate for 200g. 
                            You have {} gold.
                            What would you like to buy? drinks, or the Camelot chestplate?
                            \n'''.format(game.gold))
         if (shop_choice == 'drink' or shop_choice == 'drinks'
             ...
             if game.gold >= int(amount) * 50:
                 ...
                 enter_Camelot_market()
         elif shop_choice == 'chestplate' or shop_choice == 'Camelot chestplate' or shop_choice == 'the Camelot chestplate':
             if game.gold >= 200:
                 game.gold = game.gold - 200
                 game.equipped_chest.append("Camelot chestplate")
 ...
 # start code for Camelot=-
def village_scene():
     global game
     game.location = village_scene
     print('you entered the Camelot')
     Camelot = input('''as you enter the Camelot a few establishments stands out to you.
     There are inn, where you could be healed,
     a guild where you could accept quests,
     a shop, where ammunitions could be bought,
     a hero screen, where stat points could be spent, 
     and road to exit of the Camelot. 
     What do you like to visit?\n''')
     if Camelot == 'inn' or Camelot == 'i' and game.gold >= 100:
         villageinn()
     elif Camelot == 'inn' and game.gold < 100:
         ...
         enter_hero_screen()
     if Camelot == 'no' or Camelot == 'n' or Camelot == 'exit' or Camelot == 'leave' or Camelot == 'road':
         print("You decide to leave the Camelot and return to the crossroad")
         eastern_scene()
...
def enter_hero_screen():
 ...
 You have {game.unspent_points} to improve stats.
     ...
     if game.unspent_points > 0:
         decision = input(
             'Which one you want to improve you have? str, dex, con? or leave to leave\n')
     else:
     ...
     if decision == 'str' and game.unspent_points > 0:
         ...
         game.con += 1
         game.unspent_points = 1
         game.max_health = gconfig.default_hero_health + \
             game.player_level * 5 + game.con * 10
         if game.unspent_points > 0:
             enter_hero_screen()
         game.prev_location()
     elif decision == "leave":
...
def enter_village_guild():
     ...
     for x in questlist:
         print(x)
     decision = input(
         "you have one availible quest slot which quest would you like to take 1 or 2?\n")
     if decision == '1':
...
def enter_village_shop():
 ...
 Or you wanna leave?''')
     if (shop_choice == 'drink' or shop_choice == 'drinks'
         ...
         if game.gold >= gconfig.damask_sword_price:
             ...
             print(
                 "You bought your sword, swing it over your shoulder and headed to the exit")
             village_scene()
         else:
             print("you don't have enough money for that!")
             enter_village_shop()
         ...
         if game.gold >= gconfig.trident_price:
             ...
             print(
                 "You bought your trident, swung it over your shoulder and headed to the exit")
             village_scene()
         else:
 ...
 ##code for the Camelot
def villageinn():
     global game
     print('you enter the inn\n')
     choiceinn = input(
         'for 100 gold you can rest to full hp. Would you like to do so?\n')
     if choiceinn == 'yes' or choiceinn == 'y':
         ...
         print("Now healed you leave the Camelot and return to the crossroads")
         village_scene()
...
def calc_enemy_dmg(enemy_base_dmg):
     global game
     chance_to_evade = (round(gconfig.hero_chance_to_evade +
                        game.dex * gconfig.dex_evade_bonus, 2))*100
...
def get_hero_dmg():
     ...
     chance_to_hit = round(gconfig.hero_chance_to_hit +
                           game.dex * gconfig.dex_accuracy_bonus, 2)*100
     roll_5d20 = random.randint(1, 100)
...
def check_new_level():
     ...
     if bool_level_changed:
         game.max_health = gconfig.default_hero_health + \
             game.player_level * 5 + game.res * 10
...
def attack_regular(previous_scene, location=None, trial=False):
     ...
     print('A level', game.enemy_level, enemy_name,
           ' appears it has', game.enemy_hp, 'hp')
     if location in ['Camelot trial 1', 'Camelot trial 2', 'Camelot trial 3', 'abyssal depths 1', 'abyssal depths 2', 'abyssal depths 3', 'sea scene 1', 'sea scene 2', 'sea scene 3']:
         decision = 'fight'
     else:
     ...
     if decision == 'fight' or decision == '1':
         while game.enemy_hp > 0 and game.health >= 1:
             ...
             if enemy_dmg != 0:
                 ...
                 print('The enemy did', enemy_dmg, 'damage,',
                       'you have', game.health, 'health')
             if game.health >= 1:
                 ...
                 if player_dmg != 0:
                     if game.enemy_hp <= 0:
                         game.enemy_hp = 0
                     print('You did', player_dmg, 'damage,',
                           'the enemy has', game.enemy_hp, 'hp\n')
             elif game.health <= 0:
                 game.die()
         if game.enemy_hp <= 0:
             game.gold += 50
...
def bossfight(previous_scene):
     ...
     randoms()
     decision = input(
         "Are you sure you want to progress, there is a strong enemy ahead?\n")
     if decision == 'turn back' or decision == 'back' or decision == 'no':
         ...
         while game.boss_hp > 0 and game.health >= 0:
             ...
             print('The enemy did', bossdam, 'damage,',
                   'you have', game.health, 'health')
             if game.health < 25 and game.hp_drinks > 0:
                 game.hp_drinks = 1
                 game.health += 50
...
def randoms(enemy_location=None):
    ...
    if enemy_location   == 'Camelot trial 2':
        game.enemy_level = random.randint(5, 7)
    elif enemy_location == 'Camelot trial 3':
...
if __name__ == "__main__":
    ...
    print(" Hello there! Welcome to the crossroads!")
    print("\nMy name is Mikal but you can call me The Narrator of this story, as well as the creator of the crossroads!")
    print("\nThis crossroad is a vast place, called Vidurio which is inhabited by many creatures.\n")
    crossroads()
